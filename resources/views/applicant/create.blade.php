...
<form action="/application" enctype="multipart/form-data" method="POST" class=" main-form">
    @csrf
    <fieldset>
        <div class="bg-gray-200 rounded-md p-4 border-2 border-black hover:shadow-inner  ">
    ...
    <!-- Present ADdress -->
    <fieldset>
        <div class="mt-5 bg-gray-200 rounded  border-2 border-black hover:shadow-inner ">
    ...
    <div class="mt-5 bg-gray-200 rounded  border-2 border-black hover:shadow-inner ">
        ...
        <div class="form-group pl-3">
            ...
            <textarea required class="form-control hover:bg-green-100 transition ease-out duration-500" id="inputRemarks" name="inputRemarks" rows="3"></textarea>
        </div>
